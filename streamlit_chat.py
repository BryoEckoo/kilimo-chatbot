    ...
    if prompt :
        ...
        try:
            ...
            while True:
                ...
                if len(answer) == 1:
                    # if "result" in answer:
                    # response = answer["output"][0]["result"]
                    # source_docs = answer["output"][0]["source_documents"]
                    response = answer[0]["result"]
                    source_docs = answer[0]["source_documents"]

                    # sring to store the source docs in
                    source_response = (
        ...
        with st.chat_message("assistant"):
            # combine the answer and source documents as the repsonse
...
with col2:
    ...
    st.image(
        "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhwvWjUFp6EcHHmVhaXZ00qcWptAFra6Fuffp2KLraVETD67G7oZJ0532drzyi7XucZWnvm80vzGMZJfcIP03ATEykBY1VPmzQJRItVGcve-JY41E7Jp2xhCqzQbuFUNJXM6ZK02JBoIGoV/s1600/shoots.jpg",
        width=790,
    )
